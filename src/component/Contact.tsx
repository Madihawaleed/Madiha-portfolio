        ...
        <section id="contact" className="py-24 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-10">
                    ...
                    {/* Contact Info */}
                    <div className={`p-8 md:p-10 rounded-3xl border transition-colors duration-500 ${darkMode
                    ...
                    {/* Contact Form */}
                    <form className={`p-8 md:p-10 rounded-3xl border transition-colors duration-500 ${darkMode
                            ? "bg-white/[0.04] border-white/10"
                            : "bg-white border-slate-200 shadow-sm"
                        }`}>
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label className={`text-sm ${darkMode ? "text-gray-300" : "text-slate-700"
                                    }`}>
                                    Your Name
                                </label>
